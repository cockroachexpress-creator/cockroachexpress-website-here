...
export default function OpinionSection() {
  ...
  return (
    <section id="opinion" ref={ref} className="px-4 md:px-12 py-20 bg-surface-container-lowest">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="stagger-children grid grid-cols-1 md:grid-cols-2 gap-4">
          {opinions.map((op) => (
            <article
              key={op.title}
              className="scanline-hover bg-surface-container-low border-l-4 border-tertiary p-8 flex flex-col group transition-all hover:bg-surface-container hover:translate-x-1"
            >
              ...
              <h3
                className="text-on-surface mb-4 font-bold group-hover:text-tertiary transition-colors"
                style={{
                  fontFamily: "var(--font-montserrat)",
                  fontWeight: 700,
                  fontSize: "24px",
