...
export default function ManifestoSection() {
  ...
  return (
    <section id="manifesto" ref={ref} className="py-24 bg-background relative border-y-2 border-surface-container-highest">
      <div className="max-w-4xl mx-auto px-4 text-center mb-16">
        <span className="material-symbols-outlined text-secondary text-4xl mb-4 reveal inline-block hover:rotate-180 transition-transform duration-700 cursor-default">
          public
        </span>
        <h2
          className="text-[32px] md:text-[40px] uppercase mb-6 italic reveal"
          style={{
        ...
        <p className="text-on-surface-variant mx-auto reveal" style={{ fontSize: "18px", lineHeight: 1.6 }}>
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-4 stagger-children">
        <div className="bg-surface-container p-8 brutalist-border brutalist-shadow-tertiary hover:translate-x-[-2px] hover:translate-y-[-2px] brutalist-shadow-tertiary-hover transition-all duration-200">
          <div className="flex items-center gap-4 mb-6">
            <span
              className="material-symbols-outlined text-tertiary text-4xl hover:scale-110 transition-transform duration-200"
        ...
        <div className="bg-surface-container p-8 brutalist-border brutalist-shadow-secondary hover:translate-x-[-2px] hover:translate-y-[-2px] brutalist-shadow-secondary-hover transition-all duration-200">
          <div className="flex items-center gap-4 mb-6">
            <span
              className="material-symbols-outlined text-secondary text-4xl hover:scale-110 transition-transform duration-200"
              style={{ fontVariationSettings: "'FILL' 1" }}
            >
              rocket_launch
            </span>
